# java-template serverless API
The java-template project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=springboot-java-template -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot-archetype -DarchetypeVersion=1.4 -DgroupId=com.tmeplate -Dversion=0.0.1 -Dinteractive=false
$ cd springboot-java-template
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "PetResqrApi",
                    "OutputKey": "PetResqrApi",
